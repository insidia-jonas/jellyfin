...
class NativeShellAssetTest {
    ...
    fun `nativeshell forces the tv web layout like the iOS shell`() {
        ...
        assertFalse(script.contains("document.documentElement.style.zoom"))
        ...
        assertTrue(script.contains("\"2.3.0\"") || script.contains("2.3.0"))
        ...
        assertTrue(live.contains("resolvePlaybackManager"))
        assertTrue(live.contains("playableItem"))
        assertTrue(live.contains("webpackChunk"))
        assertFalse(live.contains("window.Emby.Page && typeof window.playbackManager"))
        ...
        assertTrue(live.contains("hideLibrarySpinner"))
        assertTrue(live.contains("window.loading.hide"))
        ...
        assertTrue(cinema.contains("firetv-live-bar"))
        assertTrue(cinema.contains("html.jf-livetv-list-on .loading"))
        assertTrue(cinema.contains("html.firetv-live-on .loading"))
