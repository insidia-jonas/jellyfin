...
public class WebScriptTests
{
    ...
    public void DownloadsList_UsesTitleRowsAndOpenTargets()
    {
        ...
        Assert.Contains("tmDlRemove", js, StringComparison.Ordinal);
        Assert.Contains("TreasureMaps/Downloads/Remove", js, StringComparison.Ordinal);
    ...
    public void TitlePage_ReplacesPosterGridIncludingAndereInhalte()
    {
        ...
        Assert.Contains("Open episode", js, StringComparison.Ordinal);
    ...
    public void SubtitlePanel_QuotesCostBeforeGenerate()
    {
        ...
        Assert.Contains("TreasureMaps/Subtitles/Generate", js, StringComparison.Ordinal);
        Assert.Contains("window.confirm", js, StringComparison.Ordinal);
        Assert.Contains("Kosten werden ermittelt", js, StringComparison.Ordinal);
    }
    ...
    public void ApplyScriptTag_InsertsThenUpgradesVersion()
    {
        ...
        Assert.Contains("TreasureMaps/ClientScript?v=8", first, StringComparison.Ordinal);

        var stale = first!.Replace("ClientScript?v=8", "ClientScript?v=3", StringComparison.Ordinal);
        var upgraded = WebScriptInjector.ApplyScriptTag(stale);
        Assert.NotNull(upgraded);
        Assert.Contains("ClientScript?v=8", upgraded, StringComparison.Ordinal);
